...
export const EditorData = () => (
  <div>
    <h3>
      ...
      reiciendis architecto consequuntur odio temporibus dolor recusandae
      laboriosam suscipit maiores, cumque porro vitae nam repudiandae culpa.
      Reiciendis doloribus dolore ad nam eos architecto, praesentium facere
      similique! Doloribus quod omnis, quasi labore soluta, cum, animi quos
      quidem quisquam iusto ea ex repellat deleniti. Tempora ipsa rerum
      aspernatur nisi amet error veritatis suscipit asperiores consectetur
      tenetur dolorem, eligendi libero, voluptas sed nobis possimus dolores cum
      voluptates ratione alias voluptatibus molestias soluta. Excepturi eveniet
      ducimus minus optio obcaecati sed. Adipisci unde soluta qui, distinctio
      rem, suscipit incidunt illum eos eveniet provident optio ad asperiores
      recusandae sunt dolore, voluptatum error veritatis voluptatibus quisquam
      commodi non hic fugiat ratione. Ducimus ut debitis nesciunt doloribus
      dolore repellendus atque beatae autem. Porro repudiandae iusto asperiores
      iste reprehenderit facilis perspiciatis ab expedita libero consequuntur,
      voluptas mollitia exercitationem illo doloribus odio repellendus
      reiciendis obcaecati. Blanditiis, sunt repudiandae. Dignissimos aliquid
      voluptatibus libero rem, consequatur impedit, recusandae obcaecati
      aspernatur ipsum in ullam atque ab sunt tenetur. Iste, ducimus itaque quis
      ullam pariatur nihil at maxime labore! Harum pariatur quos provident
      perspiciatis laudantium reprehenderit doloremque at quae! Praesentium et
      esse officiis, itaque eius repellendus laudantium deleniti inventore
      mollitia debitis nemo tempore laboriosam?
    </h3>
  </div>
);
...
export const customersData = [
  {
    ...
    ComplaintType: "Hosting Press HTML",
    Status: "Active",
    StatusBg: "#8BE78B",
    Weeks: "40",
    Budget: "$2.4k",
